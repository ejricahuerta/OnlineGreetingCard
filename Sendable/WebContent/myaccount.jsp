...
<body class="container-fluid">
	...
	<div class="collapse navbar-collapse" id="sendablenav">
		<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
			<li class="nav-item active"><a class="btn nav-link" href="#">Home
			</a></li>
			<li class="nav-item"><a class="btn nav-link" href="cards.html">Cards</a>
			</li>
			<li class="nav-item"><a class="btn nav-link"
				href="categories.html">Categories</a></li>
		</ul>
		<ul class=" navbar-nav ml-auto">
			<li class="nav-item"><a class="btn nav-link" href="login.html">Logout</a>
			</li>
		</ul>
	</div>
	</nav>
	...
	<div class="row sendable-myaccount">
		<div class="leftsidenav col-lg-3 col-md-3 col-sm-3 m-1">
			<nav class="nav flex-column text-center"> <a
				class="  nav-link shadow-sm" href="#">Profile</a> <a
				class="  nav-link shadow-sm" href="#">My Cards</a> <a
				class="  nav-link shadow-sm" href="#">Account</a> <a
				class="  nav-link shadow-sm" href="#">Payments</a> <a
				class="  nav-link shadow-sm" href="#">Security</a> </nav>
		</div>

		<!-- profile -->

		<div id="profile"
			class="sendable-main-content mt-2 col-lg-8 col-md-8 col-sm-8 border">
				...
				<div class="form-row ">
					<div class="form-group col-md-6">
						<label for="firstname">First Name</label> <input name="firstname"
							type="text"
							class="form-control bg-white border-light font-weight-bold"
							id="firstname" placeholder="First Name"
							value="${sessionScope['user'].getFullName().split(' ')[0]}"
							disabled>
					</div>
					<div class="form-group col-md-6">
						<label for="lastname">Last Name</label> <input name="lastname"
							...
							value="${sessionScope['user'].getFullName().split(' ')[1]}"
							disabled>
					</div>
				</div>
				<div class="form-group">
					<label for="line1">Line 1</label> <input name="line2" type="text"
						class="form-control bg-white border-light font-weight-bold"
						id="line1" placeholder="Line 1"
						value="${sessionScope['user'].getCurrentAddress()}"
						disabled>
				</div>
				<div class="form-group">
					<label for="line2">Line 2</label> <input name="line2" type="text"
						class="form-control bg-white border-light font-weight-bold"
						id="line2" placeholder="Apartment, studio, or floor"
						value="${sessionScope['user'].getCurrentAddress()}"
						disabled>
				</div>
				<div class="form-row">
